 ...
 */
@Entity
@Table(name = "capacidades_por_estudios", catalog = "empleabilidad", schema = "", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"idcapacidad_por_estudio"})})
@XmlRootElement
@NamedQueries({
...
public class CapacidadesPorEstudios implements Serializable {
    ...
    @Column(name = "idcapacidad_por_estudio", nullable = false)
    private Integer idcapacidadPorEstudio;
    @JoinColumn(name = "estudios", referencedColumnName = "idestudios", nullable = false)
    ...
    public String toString() {
        return "com.empleoscartagena.www.entities.CapacidadesPorEstudios[ idcapacidadPorEstudio=" + idcapacidadPorEstudio + " ]";
    }
