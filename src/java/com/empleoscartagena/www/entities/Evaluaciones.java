 ...
 */
@Entity
@Table(name = "evaluaciones", catalog = "empleabilidad", schema = "", uniqueConstraints = {
...
public class Evaluaciones implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "puntuacion", nullable = false, precision = 4, scale = 1)
    private BigDecimal puntuacion;
    @Basic(optional = false)
    @Column(name = "cualificacion", nullable = false, length = 20)
