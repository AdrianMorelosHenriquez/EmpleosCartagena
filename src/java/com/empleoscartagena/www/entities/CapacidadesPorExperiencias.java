 ...
 */
@Entity
@Table(name = "capacidades_por_experiencias", catalog = "empleabilidad", schema = "", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"idcapporexperiencia"})})
@XmlRootElement
@NamedQueries({
...
public class CapacidadesPorExperiencias implements Serializable {
    ...
    @Column(name = "idcapporexperiencia", nullable = false)
    ...
    public String toString() {
        return "com.empleoscartagena.www.entities.CapacidadesPorExperiencias[ idcapporexperiencia=" + idcapporexperiencia + " ]";
    }
